...
const getTheme = (primary, secondary, background, color70, textColor) => {
  const green0 = textColor ? textColor : "#FCFCFC";
  const green10 = primary ? primary : "#E5E5E5";
  const green20 = "#CCCCCC";
  const green30 = "#B3B3B3";
  const green40 = "#999999";
  const green50 = "#7F7F7F";
  const green60 = secondary ? secondary : "#080808";
  const green70 = color70 ? color70 : "#4D4D4D";
  const green80 = background ? background : "#080808";
  const green85 = "#212121";
  const green90 = textColor ? textColor : "#080808";
